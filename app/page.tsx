...
<div className="my-10">
  <div className="relative left-1/2 right-1/2 -mx-[50vw] w-screen px-4">
    <img
      ...
      className="w-full max-w-5xl mx-auto rounded-lg shadow-md object-cover"
    />
  </div>
...
<section className="w-full py-18 pb-0 bg-white">
...
<section className="w-full py-3 pb-12 bg-white">
  <div className="max-w-2xl mx-auto px-6 md:px-0">
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      whileInView={{ opacity: 1, y: 0 }}
